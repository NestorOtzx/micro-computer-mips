...
synth_design -top micro_computer -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef micro_computer.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file micro_computer_utilization_synth.rpt -pb micro_computer_utilization_synth.pb"
